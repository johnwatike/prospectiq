...
class Prchat_Controller extends AdminController
{
    ...
    public function __construct()
    {
        ...
        if (
            ...
            echo '<h4>Tutorial: <a target="blank" href="https://help.savoir.co.ke/setup-realtime-notifications-with-pusher-com/">See example how to setup Pusher from Perfex CRM documentation</a>';
            die;
        }
