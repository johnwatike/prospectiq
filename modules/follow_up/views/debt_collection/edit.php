...
<div id="wrapper">
  <div class="content">
    <div class="row">
            ...
            <?php echo form_open(admin_url('follow_up/debt_collection/edit/' . $record['id'])); ?>
        <div class="col-md-12">
          <div class="panel_s">
            <div class="panel-body">
              <h4 class="no-margin"><?php echo _l('edit_debt_collection'); ?></h4>
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="registration_date" class="form-control" value="<?php echo isset($record) ? $record['registration_date'] : ''; ?>" required>
                </div>
