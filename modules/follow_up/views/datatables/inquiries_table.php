...
foreach ($rResult as $aRow) {
    ...
    $viewUrl = admin_url('follow_up/inquiries/view/' . $aRow['id']);
    $editUrl = admin_url('follow_up/inquiries/edit/' . $aRow['id']);
    $deleteUrl = admin_url('follow_up/inquiries/delete/' . $aRow['id']);
