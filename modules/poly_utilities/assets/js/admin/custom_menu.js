            ...
            setup() {
                ...
                function fetchMenuItems() {
                    return new Promise((resolve, reject) => {
                        $.ajax({
                            url: `${admin_url}poly_utilities/ajax_sidebar_menu_items`,
                            type: 'GET',
                            dataType: 'json',
                    ...
                    for (var i = 0; i < nestedSortables.length; i++) {
                        new Sortable(nestedSortables[i], {
                            ...
                            onEnd: function (evt) {
                                ...
                                $.post(admin_url + 'poly_utilities/update_sidebar_menu_positions', {
                                    data: menu_active,
                ...
                function fetchCustomMenuItems() {
                    return new Promise((resolve, reject) => {
                        $.ajax({
                            url: `${admin_url}poly_utilities/ajax_custom_sidebar_menu_items`,
                            type: 'GET',
                            dataType: 'json',
                            success: function (response) {
                                resolve(response);
                ...
                const handleDelete = (item) => {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.post(admin_url + 'poly_utilities/delete_custom_sidebar_menu', data).done(function (response) {
                                window.location.reload();
                            });
                        }
                    });
