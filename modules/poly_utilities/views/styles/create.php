...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <a href="<?php echo admin_url('poly_utilities/styles'); ?>">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <select class="form-control" id="poly_utilities_is_embed_position" name="poly_utilities_is_embed_position">
                                <option value="header" <?php echo (($resourceEdit->is_embed_position === 'header' || !$resourceEdit->is_embed_position) ? ' selected' : '') ?>>Header - <?php echo _l('poly_utilities_is_embed_position_header_message') ?></option>
                                <option value="footer" <?php echo (($resourceEdit->is_embed_position === 'footer') ? ' selected' : '') ?>>Footer - <?php echo _l('poly_utilities_is_embed_position_footer_message') ?></option>
                            </select>
...
init_tail();
echo '<script src="' . base_url('modules/poly_utilities/assets/js/admin/create_style.js') . '"></script>';
