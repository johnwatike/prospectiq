                        ...
                        ?>
                            <div class="panel_s">
                                <div class="panel-body tw-pb-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-1">
                                            <label for="poly_field_aio_supports_button"><i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1 hidden-xs" data-toggle="tooltip" data-title="<?php echo _l('poly_utilities_quick_access_icon_help') ?>"></i><?php echo _l('poly_utilities_quick_access_icon') ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <div class="checkbox checkbox-primary">
                                                    <input type="checkbox" name="require_login" id="require_login" v-model="item_edit_object.require_login"><label for="require_login">&nbsp;<?php echo _l('poly_utilities_custom_menu_require_client_login_label')?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Is require login? -->
                                        <div class="form-group col-md-9 poly-utilities-specific-clients">
                                            <label style="width: 100%" for="clients"><?php echo _l('poly_utilities_custom_menu_specific_clients_label') ?>
                                                <select style="width: 100%" class="select2 clients form-control" name="clients[]" multiple="multiple">
                                                </select></label>
                                        </div>
                                    </div>
...
echo '<script src="' . base_url('modules/poly_utilities/assets/js/admin/custom_clients_menu.js') . '"></script>';
