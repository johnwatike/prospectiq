...
<div class="ui center aligned stackable grid" style="padding-right:105px">
                ...
                <table id="dialer_table">
                    <div class="column" style="font-size: 10px;">
                        <span id="output-color" class="ui tiny orange circular label"></span>&nbsp;<span
                            class="ui small header" id="output-lbl">Ready</span>
                    </div>
                    <tr>
                        <td id="call-to" colspan="3"><input style="display: block" type="number" value="<?php echo $phonenumber; ?>"
...
<!--                    </tr>-->
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="hidden" style="display: none">
                        ...
                        <td colspan="1" style="font-size: 10px;">
                            <button id="hangup-btn" class="ui negative button" disabled style="font-size: 10px;">Hangup
                            </button>
                        </td>
                    </tr>
                </table>
