    ...
    <nav>
        <div class="tw-flex tw-justify-between">
            ...
            <div class="tw-flex tw-flex-1 sm:tw-flex-initial">
                <div class="tw-inline-flex tw-items-center tw-mr-3 tw-text-sm tw-font-medium tw-text-neutral-600">
                    <span class="tw-px-2 tw-py-1 tw-bg-neutral-200 tw-rounded tw-text-neutral-700">
                        Branch: <?= e(get_git_branch()); ?>
                    </span>
                </div>
                <div id="top_search"
