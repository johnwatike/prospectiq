...
*
*/
// define('APP_BASE_URL', 'https://prospectiq.savoir.co.ke/');
...
*/
define('APP_ENC_KEY', 'e1408e4efddbc7c573efc0f9fdd7bf18');

/**
 * Database Credentials
 * The hostname of your database server
 */
define('APP_DB_HOSTNAME', '149.102.129.28');
/**
 * The username used to connect to the database
 */
define('APP_DB_USERNAME', 'ivr_phone');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'ivr_phone');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'ivr_phone');
